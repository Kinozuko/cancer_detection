...
def process_images(n_pools:int = 2):
  if os.path.exists(DATA_PATH):
    ...
    with mp.Pool(n_pools) as p:
        p.starmap(reshape_to_png, [(new_train_folder, train_images), (new_test_folder, test_images)])  
  else:
      print("To work with this script you need a data folder like we describe in the README.md")